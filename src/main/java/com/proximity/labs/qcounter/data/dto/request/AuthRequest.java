...
public abstract class AuthRequest implements Request {
    ...
    @ApiModelProperty(value = "IP address send from client at signup, this will be use to get the user creator location. Location is needed to make sure a user that want to join a queue can only join at a reasonable radius", required = true, allowableValues = "NonEmpty String")
